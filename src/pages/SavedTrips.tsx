    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#2563eb] mx-auto"></div> {/* Changed from border-voyage-600 */}
          <p className="mt-4 text-[#2563eb]">Loading your saved trips...</p> {/* Changed from text-voyage-600 */}
        </div>
      </div>
    );
  }
        ...
        <div className="container mx-auto px-4 sm:px-6 pt-24 sm:pt-32 md:pt-40 pb-12 sm:pb-16">
          <Card className="max-w-md mx-auto">
            ...
            <CardContent className="text-center">
              ...
              <Link to="/">
                <Button className="bg-[#2563eb] hover:bg-[#1d4ed8]"> {/* Changed from bg-voyage-500 hover:bg-voyage-600 */}
                  Return to Home
                </Button>
              </Link>
            </CardContent>
              ...
              {trips.map((trip) => {
                ...
                return (
                  <Card key={trip.id} className="overflow-hidden">
                    <div className="bg-[#e0effd] p-4"> {/* Changed from bg-voyage-50 (assuming #e0effd is a light blue similar to 'voyage-50') */}
